...
public class Code2XX {
	...
	private Integer id = 1;
	 ...
	 public String c201(HttpServletResponse response) {        
		 ...
		 response.setHeader("Location", "http://www.naver.com"); //리소스와 관련된 주소 들어감               
		 return "Accepted";    
	 }
	 ...
	 public void c202(HttpServletResponse response) throws IOException {        
		 ...
		 // https://alvinalexander.com/java/jwarehouse/eclipse/org.eclipse.equinox.http/src/org/eclipse/equinox/http/servlet/HttpServletResponseImpl.java.html
		 /*
